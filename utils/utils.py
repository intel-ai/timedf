...
def run_benchmarks(
    ...
    for iter_num in range(1, iterations + 1):
        ...
        # This is we do because some benchmarks miss ML part. It's a temporary solution, in the
        # long run it's better to implement https://github.com/intel-ai/omniscripts/issues/317
